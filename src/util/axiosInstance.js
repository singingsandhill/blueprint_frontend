...
export const getRealEstateSummary = async (region, sggCdNm, umdNm) => {
  try {
    ...
    const response = await axiosInstance.get(`/realestate/summary/${encodedRegion}/${encodedSggCdNm}/${encodedUmdNm}`);
...
export const getSggList = async (region) => {
  try {
    ...
    const response = await axiosInstance.get(`/realestate/sgg/${encodedRegion}`);
    return response.data;
  } catch (error) {
...
export const getUmdList = async (region, sggCdNm) => {
  try {
    ...
    const response = await axiosInstance.get(`/realestate/umd/${encodedRegion}/${encodedSggCdNm}`);
    return response.data;
  } catch (error) {
